        ...
        <div className="text-center py-4">
          ...
          <div className="flex gap-4 justify-center">
            <button
              ...
              className="px-5 py-2.5 rounded-xl border border-white/10 text-gray-300 hover:bg-white/5 transition-colors cursor-pointer text-sm font-semibold"
            >
              Cancel
            </button>
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-500 hover:to-rose-500 text-white shadow-lg shadow-red-500/20 hover:shadow-red-500/30 transition-all cursor-pointer text-sm font-semibold active:scale-95"
            >
              Log Out
            </button>
          </div>
